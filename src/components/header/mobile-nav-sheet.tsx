...
export const MobileNavSheet = () => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      ...
      <SheetContent
        side="left"
        className="px-2 flex flex-col overflow-y-auto bg-gradient-to-b from-rose-100 to-rose-200 dark:bg-gradient-to-b dark:from-zinc-800 dark:to-zinc-900"
      >
        <nav className="flex flex-col gap-y-2 pt-6 flex-1">
          <SearchComponent className="w-[calc(100%-40px)] left-[29px]" open />
          <ul>
            {menuItems.map((menu) => {
